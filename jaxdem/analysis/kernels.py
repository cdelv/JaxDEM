...
r"""Kernel typing + small helpers for JAX analysis.
...
def isf_self_isotropic_kernel(
    ...
    r"""Self intermediate scattering function (isotropic average).
...
def msad_kernel_2d(arrays: dict[str, jnp.ndarray], t0: int, t1: int) -> jnp.ndarray:
...
def isf_angular_kernel_2d(
    arrays: dict[str, jnp.ndarray], t0: int, t1: int, *, theta_0: float
) -> jnp.ndarray:
