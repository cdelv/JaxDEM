...
def minimize(
    ...
    r"""Minimize the energy of the system until either of the following conditions are met:
    ...
    def cond_fun(
        ...
        _state, _system, step_count, pe, prev_pe = carry
    ...
    def body_fun(
        ...
        new_pe = cast(float, (pe_force_manager + pe_collider) / N)
